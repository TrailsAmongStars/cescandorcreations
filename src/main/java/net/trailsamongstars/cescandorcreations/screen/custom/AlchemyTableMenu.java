package net.trailsamongstars.cescandorcreations.screen.custom;
...
import net.trailsamongstars.cescandorcreations.block.entity.AlchemyTableBlockEntity;
...
public class AlchemyTableMenu extends AbstractContainerMenu {
    ...
    public AlchemyTableMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public AlchemyTableMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.ALCHEMY_TABLE.get());
    }
